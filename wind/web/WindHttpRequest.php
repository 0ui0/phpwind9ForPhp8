...
class WindHttpRequest implements IWindRequest {
	...
	public function getIsAjaxRequest() {
		return !strcasecmp((string)$this->getServer('HTTP_X_REQUESTED_WITH'), 'XMLHttpRequest');
	}
	...
	public function isSecure() {
		return !strcasecmp((string)$this->getServer('HTTPS'), 'on');
	}
	...
	public function isGet() {
		return !strcasecmp((string)$this->getRequestMethod(), 'GET');
	}
	...
	public function isPost() {
		return !strcasecmp((string)$this->getRequestMethod(), 'POST');
	}
	...
	public function isPut() {
		return !strcasecmp((string)$this->getRequestMethod(), 'PUT');
	}
	...
	public function isDelete() {
		return !strcasecmp((string)$this->getRequestMethod(), 'Delete');
	}
